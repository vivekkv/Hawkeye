...
export default class SummaryBox extends React.Component {
    ...
    render() {
        ...
        return <div className={["m-portlet m-portlet--full-height m-portlet--fit box-shadow", Styles.summaryBox, this.props.className].join(" ")} style={this.props.style}>
            ...
            <div className={["m-portlet__body", this.props.body_style].join(" ")}>
                ...
                {this.props.children}
                    ...
                    {
                            this.props.showHelpText == true ?  
                                <p className={Styles.helpText}>{this.props.helpText ? this.props.helpText: ""}</p>: null
                    }
